// Create a new page in src/pages/EditMessage/EditMessage.jsx
import React from 'react';
import './EditMessage.css';
import { Input, Row, Col, Form , Button, Typography, Space, DatePicker, TimePicker, message } from 'antd';
...
const EditMessage = () => {
    ...
    const onSubmit = (values) => {
        ...
        const scheduledAt = moment(date.format('YYYY-MM-DD') + ' ' + time.format('hh:mm: A'));
                ...
                <Form onFinish={onSubmit}>
                    <Row gutter={16}>
                        <Col span={24}>
                            ...
                            >
                                <Input.TextArea placeholder='Write your message here...' rows={3} />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Row gutter={16}>
                        <Col span={12}>
                            <Form.Item label="Date" name="date" required
                                ...
                                <DatePicker placeholder='February 12, 2023' disabledDate={disabledDate} style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            ...
                            >
                                <TimePicker placeholder='7:30AM' format="hh:mm A" minuteStep={10} use12Hours style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Row gutter={16}>
                        <Col span={24}>
                            <Form.Item>
                                <Button type="primary" htmlType="submit">{data.id ? 'Update' : 'Schedule'}</Button>
                            </Form.Item>
                        </Col>
                    </Row>
                </Form>
